...
class PaginationAdmin
{
    ...
    public function get()
    {
        ...
        for ($page = $limits[0]; $page <= $limits[1]; $page++) {
            # Если текущая это текущая страница, ссылки нет и окрашиваем в цвет
            if ($page == $this->current_page) {
                $links .= '<a class="pagination" style="color: red" href="#">' . '  ' . $page . '</a> ';
            } else {
    ...
    private function generateHtml($page, $text = null)
    {
        ...
        return
            '<a class="pagination" href="' . $currentURI . $this->index . $page . '">'  . $text . '</a> ';
    }
